...
export default function Leaderboard() {
  ...
  // If not in top 50, maybe create a mock entry from session data? 
  // For now, simpler to show if found.
  // Actually, we should check by ID if possible, but backend only returns username/anonymized.
  // We can try to match by username if public. 
