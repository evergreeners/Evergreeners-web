...
async function main() {
    ...
    try {
        console.log("Adding eye_insight_count column to users table...");
        await sql`ALTER TABLE evergreeners.users ADD COLUMN IF NOT EXISTS eye_insight_count integer DEFAULT 0`;
